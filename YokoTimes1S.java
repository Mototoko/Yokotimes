...
public class YokoTimes1S extends JPanel {
    ...
    public YokoTimes1S() {
        // 背景画像を読み込みます
        try {
            backgroundImage1 = ImageIO.read(new File("yokotanokao.jpg"));
            backgroundImage2 = ImageIO.read(new File("yokotanokao2.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    protected void paintComponent(Graphics g) {
        ...
        // 背景画像を円内に合わせて描画します
        BufferedImage backgroundImage = toggleImage ? backgroundImage2 : backgroundImage1;
